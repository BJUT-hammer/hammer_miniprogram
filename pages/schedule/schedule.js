...
Page({
  ...
  data: {
    sch_listData: [],
    dateArray: [{ weekName: "周一", weekNum: 0 }, { weekName: "周二", weekNum: 1 }, { weekName: "周三", weekNum: 2 }, { weekName: "周四", weekNum: 3 }, { weekName: "周五", weekNum: 4 }, { weekName: "周六", weekNum: 5 }, { weekName: "周日", weekNum: 6 }],
    classArray: [{ time_title: "1" }, { time_title: "2" }, { time_title: "3" }, { time_title: "4" }, { time_title: "5" }, { time_title: "6" }, { time_title: "7" }, { time_title: "8" }, { time_title: "9" }, { time_title: "10" }, { time_title: "11" }, { time_title: "12" }]
  },
